...
namespace LLSDA.Entities
{
    ...
    public static class StrikesDistributionStatistic
    {
        ...
        /// 计算年分布情况，耗时操作。
        /// </summary>
        public static Dictionary<int, int> CalcuYearDistribution(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// <returns></returns>
        public static List<int> CalcuYearList(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// 计算正闪年分布情况，耗时操作。
        /// </summary>
        public static Dictionary<int, int> CalcuYearDistributionPositive(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
                ...
                var query = _strikes.Where(record => record.Intensity >= 0).Select(record => record);
        ...
        /// 计算负闪年分布情况，耗时操作。
        /// </summary>
        public static Dictionary<int, int> CalcuYearDistributionNegative(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// 统计月份分布情况，耗时操作。
        /// </summary>
        public static Dictionary<int, int> CalcuMonthDistribution(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<int, int> CalcuMonthDistributionPosive(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<int, int> CalcuMonthDistributionNegative(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// 统计时间分布情况，耗时操作。
        /// </summary>
        public static Dictionary<int, int> CalcuHourDistribution(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<int, int> CalcuHourDistribution_Positive(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<int, int> CalcuHourDistribution_Negative(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                Dictionary<int, int> resultDistribution = new Dictionary<int, int>();
        ...
        /// <returns></returns>
        private static double CacuLJProbability(IEnumerable<LightningStrike_Standard> _strikes, int limitedCurValue)
        {
        ...
        /// </summary>
        public static Dictionary<int, double> CalcuProbabilityDistribution(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        //文字描述
        //生成年分布文字描述
        public static string GenerateYearDistributionText(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// </summary>
        public static string GenerateHourDistributionText(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// </summary>
        public static string GenerateMonthDistributionText(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// </summary>
        public static string GenerateProbabilityDistributionText(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// 统计雷电流强度区间概率
        /// </summary>
        public static Dictionary<string, double> CalcuIntensityProbabilityDistribution(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<string, double> CalcuIntensityProbabilityDistributionPositive(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                // 统计雷电流强度区间概率，赋值intensityProbabilityDistribution, intensityProbabilityDistributionPositive, intensityProbabilityDistributionNegative
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<string, double> CalcuIntensityProbabilityDistributionNegative(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
                // 统计雷电流强度区间概率，赋值intensityProbabilityDistribution, intensityProbabilityDistributionPositive, intensityProbabilityDistributionNegative
        ...
        /// </summary>
        /// <returns></returns>
        private static double CalcuProbability(Section _section, IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
            {
        ...
        /// <returns></returns>
        private static bool WhetherStrikeInSection(LightningStrike_Standard _strike, Section _section)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private static List<Section> InitiateSectionList()
        {
        ...
        /// 计算平均年雷电日并返回
        /// </summary>
        public static double GetLightningDaysPerYear(IEnumerable<LightningStrike_Basic> _strikes, double _years) 
        {
            if (_strikes.Any())
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static LightningStrikeDays GetLightningStrikesDays(IEnumerable<LightningStrike_Basic> _strikes, string _administrativeRegionName)
        {
            if (_strikes.Any())
            {
                LightningStrikeDays resultDays = new LightningStrikeDays(_strikes, _administrativeRegionName);
                return resultDays;
            }
            else
        ...
        public static double CalcuMaxPositiveIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
        ...
        public static double CalcuMinPositiveIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity >= 0).Any())
        ...
        public static double CalcuMaxNegativeIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity <= 0).Any())
                    return _strikes.Select(r => r.Intensity).Max();
        ...
        public static double CalcuMinNegativeIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity <= 0).Any())
                    return _strikes.Select(r => r.Intensity).Min();
        ...
        public static double CalcuPositiveAvgIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity >= 0).Any())
        ...
        public static double CalcuNegativeAvgIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity <= 0).Any())
                    return _strikes.Select(r => r.Intensity).Average();
        ...
        public static double CalcuAbsAvgIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
        ...
        public static double CalcuAbsMinIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            //超过300KA的数据是没有意义的
            if (_strikes.Any())
        ...
        public static double CalcuAbsMaxIntensity(IEnumerable<LightningStrike_Standard> _strikes)
        {
            //超过300KA的数据是没有意义的
            if (_strikes.Any())
        ...
        public static Int64 CalcuPositiveSumNum(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity >= 0).Any())
        ...
        public static Int64 CalcuNegativeSumNum(IEnumerable<LightningStrike_Standard> _strikes)
        {
            if (_strikes.Any())
                if (_strikes.Where(r => r.Intensity <= 0).Any())
                    return _strikes.Where(r => r.Intensity <= 0).LongCount();
        ...
        public static Int64 CalcuSumNum(IEnumerable<LightningStrike_Basic> _strikes)
        {
            if (_strikes.Any())
        ...
        /// </summary>
        /// <returns></returns>
        public static string ProcessLightningBulletinDesc(IEnumerable<LightningStrike_China> _strikes, string _administrativeRegionName)
        {
            string resultString = string.Empty;
            ...
            if (_strikes.Any())
            {
                LightningStrike_Standard strikeStandardFirst, strikeStandardLast;
                strikeStandardFirst = (LightningStrike_Standard)_strikes.OrderBy(r => r.DateAndTime).Select(r => r).FirstOrDefault();
                strikeStandardLast = (LightningStrike_Standard)_strikes.OrderBy(r => r.DateAndTime).Select(r => r).LastOrDefault();
        ...
        /// </summary>
        /// <returns></returns>
        public static string ProcessLightningBulletinDesc(IEnumerable<LightningStrike_China> _strikes)
        {
            string resultString = string.Empty;
            //xx地区初雷日为x月x日，终雷日为y月y日。
            //地区内正闪最大雷电强度：xxkA,正闪最小强度：xxkA；
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        public static Dictionary<string, int> ProcessAreaDistribution(IEnumerable<LightningStrike_China> _strikes, AdministrativeLevel _administrativeLevelEnum)
        {
        ...
        /// <returns></returns>
        private static List<string> ProcessAreaList(IEnumerable<LightningStrike_China> _strikes, AdministrativeLevel _administrativeLevelEnum)
        {
            List<string> areaList = new List<string>();
            if (_administrativeLevelEnum == AdministrativeLevel.国家)
            {
                areaList = _strikes.Select(r => r.Province).Distinct().ToList();
            }
            else if (_administrativeLevelEnum == AdministrativeLevel.省)
            {
                areaList = _strikes.Select(r => r.City).Distinct().ToList();
            }
            else if (_administrativeLevelEnum == AdministrativeLevel.市)
            {
                areaList = _strikes.Select(r => r.District).Distinct().ToList();
            }
            else if (_administrativeLevelEnum == AdministrativeLevel.县)
            {
                return null;
                //无下级单位
        ...
        /// <param name="_strikes"></param>
        /// <returns></returns>
        private static int CalculateNumber(IEnumerable<LightningStrike_China> _strikes, AdministrativeLevel _administrativeLevelEnum, string _areaName)
        {
            int resultNum = 0;
            switch (_administrativeLevelEnum)
            {
                case AdministrativeLevel.国家:
                    resultNum = _strikes.Where(r => r.Province == _areaName).Count();
                    break;
                case AdministrativeLevel.省:
                    resultNum = _strikes.Where(r => r.City == _areaName).Count();
                    break;
                case AdministrativeLevel.市:
                    resultNum = _strikes.Where(r => r.District == _areaName).Count();
                    break;
                case AdministrativeLevel.县:
        ...
        ///// </summary>
        ///// <returns></returns>
        //public static Dictionary<LightningStrikeDirectionEnum, double> CalcuLightningStrikeDirectionProbabilityDistribution(IEnumerable<LightningStrike_Standard> _strikes,PointLocation _point)
        //{ 
        //    if (_strikes.Any())
        //    {
        ...
        ///// <param name="_strikes"></param>
        ///// <returns></returns>
        //private static double CalcuLightningStrikeDirectionProbability(IEnumerable<LightningStrike_Standard> _strikes, LightningStrikeDirectionEnum _directionEnum,PointLocation _centerPoint)
        //{
        //    double result = 0;
        //    int suitedNum = 0;
        ...
        ///// <param name="_strike"></param>
        ///// <returns></returns>
        //private static LightningStrikeDirectionEnum JudgeLightningStrikeDirection(LightningStrike_Standard _strike, PointLocation _centerPoint)
        //{
        ...
        /// <returns></returns>
        public static double CalcuNg(long strikesNumber, double size, double yearNum)
        {
            if (size != 0 && yearNum != 0)
