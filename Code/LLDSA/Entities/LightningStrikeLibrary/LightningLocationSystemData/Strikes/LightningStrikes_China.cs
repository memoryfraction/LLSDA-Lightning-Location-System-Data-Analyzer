...
{
    public class LightningStrikes_China: BaseStrikesChina
    {
        public LightningStrikes_China(IEnumerable<LightningStrikeChina> _strikes_China, IStrikesDistributionStatisticService _iStrikesDistributionStatisticService)
        {
