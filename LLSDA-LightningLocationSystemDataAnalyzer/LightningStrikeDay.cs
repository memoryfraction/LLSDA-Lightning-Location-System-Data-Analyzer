...
{
    public class LightningStrikeDay
    {
        DateTime dateTime;
        ...
        public LightningStrikeDay(LightningStrike_Basic _strike, string _administrativeRegionName)
        {
    ...
    public class LightningStrikeDays
    {
        #region 构造函数

        public LightningStrikeDays(IEnumerable<LightningStrike_Basic> _strikes, string _administrativeRegionName)
        {
            if (_administrativeRegionName != null)
                administrativeRegionName = _administrativeRegionName;
            lightningStrikesDayList = new ConcurrentBag<LightningStrikeDay>();
            lightningStrikesDayList = Initiate(_strikes, _administrativeRegionName, parallel);
        }

        public LightningStrikeDays(IEnumerable<LightningStrike_Basic> _strikes)
        {
            lightningStrikesDayList = new ConcurrentBag<LightningStrikeDay>();
        ...
        ConcurrentBag<LightningStrikeDay> lightningStrikesDayList;


        
        public ConcurrentBag<LightningStrikeDay> LightningStrikesDayList
        {
        ...
        public LightningStrikeDay this[int index]
        {
            get
            {
        ...
        private ConcurrentBag<LightningStrikeDay> Initiate(IEnumerable<LightningStrike_Basic> _strikes, string _administrativeRegionName, bool parallel)
        {
            if (_strikes.Any())
            {
                ConcurrentBag<LightningStrikeDay> lightningStrikesDayResultList = new ConcurrentBag<LightningStrikeDay>();
                if (parallel)//并行
                {
        ...
        public Dictionary<int, double> StaticLightningStrikesDayMonthly(int _year)
        {
            try
            {
        ...
        public Dictionary<int, double> StaticLightningStrikesDayMonthly()
        {
            try
            {
        ...
        /// <returns></returns>
        public List<int> StatisticYearList(IEnumerable<LightningStrikeDay> _lightningStrikesDayList)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Dictionary<int, LightningStrikeDay>> StatisticLightningStrikesDayYearly(IEnumerable<LightningStrikeDay> _lightningStrikeDays)
        {
            try
            {
                List<Dictionary<int, LightningStrikeDay>> result = new List<Dictionary<int, LightningStrikeDay>>();
                List<int> yearList = StatisticYearList(_lightningStrikeDays);
                foreach (var tmpYear in yearList)
                {
                    Dictionary<int, LightningStrikeDay> tmpDic = new Dictionary<int, LightningStrikeDay>();
