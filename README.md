...
* For Code：
[LGPL License, Version 3.0](http://www.gnu.org/licenses/lgpl.html)(the "License")
...
## 知识产权
* 非代码部分:  [署名-非商业性使用-相同方式共享 4.0 国际 (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)
